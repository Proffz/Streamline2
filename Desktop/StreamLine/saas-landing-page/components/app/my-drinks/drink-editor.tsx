      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            >
              CoG: {formatNumber(calculateCostOfGoods(calculateCost(ingredients), editedDrink.price))}%
            </span>
          </div>
          <Input id="cost" type="number" value={formatNumber(calculateCost(ingredients))} readOnly />
        </div>
        <div>
        ...
        <div>
          ...
          <Input
            id="profit"
            type="number"
            value={formatNumber(editedDrink.price - calculateCost(ingredients))}
            readOnly
          />
        </div>
      </div>
