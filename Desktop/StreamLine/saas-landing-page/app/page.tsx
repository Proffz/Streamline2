              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                    Menu Calculator for Bars & Restaurants
                  </h1>
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-12">
              ...
              <div className="flex flex-col justify-between space-y-4 rounded-lg border p-6 shadow-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    "StreamLine has completely transformed how we price our menu items. We've increased our profit
                    margins by 15% in just three months."
                  </p>
                </div>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Bar Manager, The Cocktail Club</p>
                  </div>
                </div>
              </div>
              {/* Testimonial 2 */}
              <div className="flex flex-col justify-between space-y-4 rounded-lg border p-6 shadow-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    "The ingredient tracking feature alone has saved us thousands in inventory costs. I can't imagine
                    running our restaurant without it now."
                  </p>
                </div>
                <div className="flex items-center space-x-4">
                  <Image
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Owner, Urban Bistro</p>
                  </div>
                </div>
              </div>
              {/* Testimonial 3 */}
              <div className="flex flex-col justify-between space-y-4 rounded-lg border p-6 shadow-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    "As a new bar owner, StreamLine gave me the confidence to price my menu correctly from day one. The
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Owner, Craft & Co.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground md:text-xl">
                    StreamLine was founded in 2020 by a team of bar owners and tech enthusiasts who saw a need for
      ...
      <footer className="w-full border-t bg-background py-12">
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Optimizing menu pricing and profitability for bars and restaurants since 2020.
              </p>
          ...
          <div className="mt-8 border-t pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-sm text-muted-foreground mt-4 md:mt-0">Made with ❤️ in Stockholm, Sweden</p>
          </div>
        </div>
      </footer>
    </div>
