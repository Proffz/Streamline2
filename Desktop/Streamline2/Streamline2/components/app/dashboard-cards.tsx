...
export function DashboardCards() {
  ...
  // Calculate average profit multiplier using pre-tax price
  ...
  // Calculate average cost of goods using pre-tax price
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {activeMenu ? `Based on ${activeMenu.name} menu` : "No active menu selected"}
          </p>
        </CardContent>
      </Card>
      <Card>
